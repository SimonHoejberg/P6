...
Analytics, and use the \textc{send} method to send send the information. In
...
\subsection{T731 - LogIn: Design new login UI for the Launcher}
Following T708, \autoref{S2Invalid}, we found a design manual which
covered how to make each application recognizable as a GIRAF
...
more than 20 minutes they will automatically be logged out and directed to the
login screen, while a citizen will remain logged in, as their session will
not expire.\\
