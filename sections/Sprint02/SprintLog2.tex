...
and the stack trace are saves as the two strings \textc{message} and
...
\fix{}{Write about our solution as presented below.}\nl
...
\subsection{T708 - Meeting: Discuss overall design goals for the GIRAF GUI}
\fix{}{Write this}

\subsection{T709 - Meeting: Define UI questions}
\fix{}{Write this}
...
\subsection{T739 - Wiki: Document pictosearch info on the wiki}
\fix{}{Write this}
