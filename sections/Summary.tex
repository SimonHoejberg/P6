\chapter*{Summary\markboth{Summary}{Summary}} In this report we present our work
on the GIRAF multi-project which was started in 2011 \citep{GIRAF2011}. It is a
...
and developing upon a complex software system in a larger develoment
environment.\nl
...
of replacing the current backend with the REST client and server developed by
other project groups. Based on this responsibility, this report is focused on
...
functionality in the \textc{Launcher}. We have also familarized ourselves
