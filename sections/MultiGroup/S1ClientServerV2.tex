...
to establish a high quality framework for server-client communication. These
...
(SW609 and SW610), in order to determine the database resource requirements for
the individual applications. Considering the incomplete state of the previous
...
\fix{}{Update in order to represent our actual requirements (If any changes
exist).}
\begin{itemize}
