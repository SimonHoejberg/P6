...
reference the framework which is used to request information from the database\\
\hline
\end{tabular}
...
the switch to \textc{REST} in sprint 3 and 4. During the reading of the
...
of what \textc{REST} is in the context of application development and how the
\textc{REST} client library is structured. Then the reader should continue with
