...
\autoref{NEWsetGrayScale}. There is a small problem as currently the
\textc{dialogs} are not grayscaled when the \textc{root View} is.
We think this is because they are not attached to it, but due to time
constraints we have choosen to pass this particular part to next years
students.
...
\fix{}{Put a picture of grayscaled rootview with a colored dialog}
