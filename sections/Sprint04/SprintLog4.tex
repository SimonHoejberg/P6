...
short wikipedia page to describe the important parts of \textc{Component Lib},
...
\figx[0.5]{Sprint4_piechart2}{The percentage of total time for the tasks which
have been resolved.}
...
\figx[0.2]{Sprint4_burndownchart}{The burndown chart for sprint 4.}
