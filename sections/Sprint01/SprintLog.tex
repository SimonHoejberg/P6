...
\subsection{T636, T646 - Identify Apps Required Resources}\label{ReqResources}
The following is part of a multigroup collaboration chapter and is described
more indepth in \autoref{S1CS}. At the beginning of the sprint we had a meeting
with SW610, SW613, and SW615 in order to determine what database resources each
...
resources has been relegated to the database groups SW613 and SW615. As such,
we consider our part of this task to be completed.

\subsection{T647 - Document Apps' Database Requirements}
During the same meeting as T636 and T646 we made the following UML diagram,
modelling the client-server interface.
