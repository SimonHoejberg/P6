...
implementation simply checks that the Android \textc{Intent} is not null, this
...
\textc{Intent} for the Launcher to supply to the Weekplanner when it launches
it. The \textc{Intent} has been added to the \textc{AppViewCreationUtility}
