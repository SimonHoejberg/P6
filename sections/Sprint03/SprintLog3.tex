...
\subsection{T834 - Implement new login screen}
...
library and laying the foundation for removing the now deprecated \textc{db-lib}
...
completely replacing the \textc{db-lib} library.
